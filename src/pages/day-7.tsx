...
export default function Day7() {
  ...
  const [title, setTitle] = useState("Day 7: ");
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        console.log("DAY 7 PREVIEW RAW ROW:", row);
        ...
        console.log("DAY 7 PREVIEW NORMALIZED:", normalized);
        setSections(normalized.sections);
      } catch (err) {
        console.error("Error loading day 7:", err);
        setSections([]);
      } finally {
        setLoading(false);
      }
