...
export default function Day4() {
  ...
  const [title, setTitle] = useState("Day 4: ");
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        console.log("DAY 4 PREVIEW RAW ROW:", row);
        ...
        console.log("DAY 4 PREVIEW NORMALIZED:", normalized);
        setSections(normalized.sections);
      } catch (err) {
        console.error("Error loading day 4:", err);
        setSections([]);
      } finally {
        setLoading(false);
      }
