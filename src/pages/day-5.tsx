...
export default function Day5() {
  ...
  const [title, setTitle] = useState("Day 5: ");
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        console.log("DAY 5 PREVIEW RAW ROW:", row);
        ...
        console.log("DAY 5 PREVIEW NORMALIZED:", normalized);
        setSections(normalized.sections);
      } catch (err) {
        console.error("Error loading day 5:", err);
        setSections([]);
      } finally {
        setLoading(false);
      }
